...
fun toDeadlineStrategyText(strategy: DeadlineCalculationStrategyType) =
    when (strategy) {
        ...
        DeadlineCalculationStrategyType.FromLastDeadline -> "Next deadline from last deadline with skipping past deadlines"
        DeadlineCalculationStrategyType.NoSkip -> "Next deadline from last deadline without skipping"
    }
